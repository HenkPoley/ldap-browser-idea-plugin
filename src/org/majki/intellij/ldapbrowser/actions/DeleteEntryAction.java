...
public class DeleteEntryAction extends LdapTreeAction {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        getTreePanel(e).ifPresent(treePanel -> getSelectedNodes(treePanel.getTree())
            ...
            .findFirst()
            .ifPresent(treeNode -> deleteEntry(treePanel, treeNode)));
    }

    public static void deleteEntry(LdapTreePanel treePanel, LdapTreeNode treeNode) {
        ...
        int result = Messages.showOkCancelDialog("Do you really want to delete Entry: " + dn, "Delete Entry", "Delete", "Cancel", AllIcons.Actions.GC);
    ...
    public void update(AnActionEvent e) {
        boolean canDeleteEntry = getSelectedNodes(e)
            .filter(LdapTreeNode.class::isInstance)
            .map(LdapTreeNode.class::cast)
            .findFirst()
            .isPresent();
